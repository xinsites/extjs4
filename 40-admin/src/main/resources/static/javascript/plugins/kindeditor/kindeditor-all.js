...
KindEditor.plugin('filemanager', function(K) {
	var self = this, name = 'filemanager',
		fileManagerJson = K.undef(self.fileManagerJson, self.basePath + 'net/file_manager_json.ashx'),
...
KindEditor.plugin('flash', function(K) {
	var self = this, name = 'flash', lang = self.lang(name + '.'),
		...
		uploadJson = K.undef(self.uploadJson, self.basePath + 'net/upload_json.ashx');
	self.plugin.flash = {
		edit : function() {
			var html = [
...
SWFUpload.prototype.getFlashHTML = function () {
	...
	// Fix bug for IE9
	// http://www.kindsoft.net/view.php?bbsid=7&post_id=5825&pagenum=1
	var classid = '';

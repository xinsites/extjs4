Ext.define('Ext.ux.form.field.KindEditor', {
    ...
    afterRender: function () {
        ...
        if (!me.ke) {
            me.ke = KindEditor.create("#" + me.getInputId(), Ext.apply(me.kindeditorConfig, {
                ...
                width: '100%',
                zIndex: 20000,
                resizeType: me.kindeditorConfig.resizeType || 0,  //2时可以拖动改变宽度和高度，1时只能改变高度，0时不能拖动
//                minHeight: me.kindeditorConfig.minHeight || 50,
...
Ext.define('Ext.ux.form.field.KindEditor2', {
    extend: 'Ext.form.field.TextArea',
    alias: 'widget.kindeditor2', //xtype名称
    initComponent: function () {
        //alert(this.basePath);

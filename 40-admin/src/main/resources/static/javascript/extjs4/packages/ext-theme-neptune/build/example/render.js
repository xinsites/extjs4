...
Ext.theme = {
     ...
     * 
     * @param manifest.design {Object} The component configuration object. The properties
     ...
     * 
     *      var design = Ext.apply(Ext.apply({}, manfiest.design), shortcut.design);
     ...
     * any string properties of the shortcut or its `design` object.
     * 
     * Usage:
     * 
    ...
    applyShortcut: function (manifestEntry, shortcut) {
        ...
        entry.config = config; // both guys have "design" so smash merged one on now...
        return entry;
    },

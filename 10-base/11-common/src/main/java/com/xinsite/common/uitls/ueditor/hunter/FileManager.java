package com.xinsite.common.uitls.ueditor.hunter;
...
import com.xinsite.common.uitls.ueditor.define.MultiState;
...
//		File dir = new File( this.dir );  
		File dir = new File( PathFormat.parse(this.dir) );  //  路径中有变量时变量不转化问题
		State state = null;

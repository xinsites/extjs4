...
public final class ConfigManager {
     ...
     */
    private ConfigManager(String rootPath, String relativePath, String uri) throws IOException {
        rootPath = rootPath.replace("\\", "/");
        this.rootPath = rootPath;
        this.originalPath = rootPath + relativePath;
        this.initEnv();
    }
     ...
     * @param relativePath 服务器所在项目路径
     * @param uri          当前访问的uri
     * @return 配置管理器实例或者null
     */
    public static ConfigManager getInstance(String rootPath, String relativePath, String uri) {
        try {
            return new ConfigManager(rootPath, relativePath, uri);
        } catch (Exception e) {
            return null;
        }
